...
function displayCheckoutItems(cart) {
    ...
    cart.forEach(item => {
        ...
        const fallbackImage = '../src/images/dummy-product.jpg';
        if (!itemImage) {
        ...
        itemElement.innerHTML = `
            <div class="item-image">
                <img src="${itemImage}" alt="${itemName}"
                     onerror="if(this.getAttribute('data-fallback-tried') !== 'true') { this.setAttribute('data-fallback-tried', 'true'); this.src='../src/images/dummy-product.jpg'; }">
            </div>
